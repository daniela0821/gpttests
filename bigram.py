...
eval_interval = 100  # Frequency of validation loss checks
learning_rate = 1e-3  # Step size for learning
device = 'cuda' if torch.cuda.is_available() else 'cpu'  # Use GPU if available
eval_iters = 200  # Number of iterations for evaluation
n_embd = 64  # Size of embeddings
n_head = 4  # Number of attention heads
n_layer = 4  # Number of transformer blocks
dropout = 0.0  # Dropout rate (helps prevent overfitting)
torch.manual_seed(1337)

# Load tokenizer (GPT-2 for word-level tokenization)
tokenizer = AutoTokenizer.from_pretrained("gpt2")
vocab_size = tokenizer.vocab_size  # Adjust vocab size based on tokenizer
